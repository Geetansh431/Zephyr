...
export const NavBar = () => {
  // State for toggling audio and visual indicator - START WITH AUDIO ENABLED
  ...
  }, [hasUserInteracted, isAudioPlaying]);

  // Set audio volume when component mounts
  useEffect(() => {
    if (audioElementRef.current) {
      audioElementRef.current.volume = 0.3; // Set to 30% volume
    }
  }, []);
